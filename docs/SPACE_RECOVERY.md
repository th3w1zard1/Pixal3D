...
| Browser gallery → GLB | **Automated** — `./scripts/browser_glb_smoke.sh` opens `?smoke=1&smoke_autoload=1&smoke_autogen=1` (in-page autoload; plan 048); exit **0** = `data-smoke-glb-ready`; **1** quota/viewer error; **2** timeout |
