...
**Last gate (2026-05-24, plan 060):** `./scripts/agent_gate.sh` — stdout JSON only (`jq .overall_ok`); `browser_exit: 1` quota path verified. **Last CLI generate (2026-05-24):** `--generate` pass (~124s, `glb_path`, `extract_available: true`).
