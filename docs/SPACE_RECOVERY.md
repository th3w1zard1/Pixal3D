...
**Last gate (2026-05-24, plan 064):** `./scripts/agent_gate.sh` — `schema_version: pixal3d-agent-gate/2`, `overall_ok: true`, `browser_exit: 1` (quota verified). **Last CLI generate (2026-05-24):** `--generate` pass (~124s, `glb_path`, `extract_available: true`).
